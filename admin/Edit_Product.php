  ...
  if (mysqli_num_rows($result) > 0) {
    // output data of each row
     while($row = mysqli_fetch_assoc($result)) {
      ...
      $img = $row['img'];
      $image = '/Project/'.$row['imgpath'].$row['img'];
    }
  } else {
    header('Location: http://localhost:8080/Project/admin/AddProduct.php?type=error&msg='.urlencode("Invalid Product found"));
  }
}
else{
  header('Location: http://localhost:8080/Project/admin/AddPproduct.php?type=error&msg='.urlencode("Invalid Product found"));
}
?>
  ...
  <div class="w3-row-padding w3-margin-bottom">
    ...
    <form  method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" required="" value='<?=$imgname?>' name="imgname" id="imgname" placeholder="Enter Name">
      </div>

      <div class="form-group">
        <label for="Lastname">Price:<span style='color:red'>*</span></label>
        <input type="text" class="form-control" required="" value='<?=$price?>' name="price" id="price" placeholder="Enter Price">
      </div>
<!-- 
      <div class="form-group">
 ...
 -->
      <div class="form-group">
        ...
        <input type="file" class="form-control" name="fileToUpload" id="fileToUpload" placeholder="Enter Image Path">
